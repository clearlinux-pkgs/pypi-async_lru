...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707110802
...
cp %{_builddir}/async-lru-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-async_lru/b457136116b205225ac482334696ffb58b30946d || :
