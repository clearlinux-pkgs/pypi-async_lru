...
Source0  : https://files.pythonhosted.org/packages/b2/4d/71ec4d3939dc755264f680f6c2b4906423a304c3d18e96853f0a595dfe97/async_lru-2.0.5.tar.gz
Summary  : Simple LRU cache for asyncio
Group    : Development/Tools
License  : MIT
Requires: pypi-async_lru-license = %{version}-%{release}
...
%package license
Summary: license components for the pypi-async_lru package.
Group: Default

%description license
license components for the pypi-async_lru package.
...
%prep
%setup -q -n async_lru-2.0.5
cd %{_builddir}/async_lru-2.0.5
pushd ..
cp -a async_lru-2.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742453228
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/pypi-async_lru
cp %{_builddir}/async_lru-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-async_lru/b457136116b205225ac482334696ffb58b30946d || :
...
/usr/share/package-licenses/pypi-async_lru/b457136116b205225ac482334696ffb58b30946d
